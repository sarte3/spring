...
<div id="mem_section">
	<form method="post" action="member_ok" name="pkc"
		...
		<table width="500" align="center">
			...
			<tr>
				<td>아이디</td>
				<td><input type="text" name="userid"> <br> <span
					id="uid"></span> <!-- 아이디 사용가능한지의 여부 --></td>
				<td><input type="button" value="중복확인"
					onclick="userid_dupcheck(this.form)"></td>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td>이메일</td>
				<td><input type="text" name="email"> <br> <span
					id="ema"></span></td>
				<td><input type="button" value="중복확인"
					onclick="email_dupcheck(this.form)"></td>
			</tr>
			<tr>
				<td>휴대폰</td>
			...
			<tr>
				...
				<td><input type="button" value="주소검색" onclick="juso_search()">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>성별</td>
				<td colspan="2"><input type="radio" name="sung" value="0">남자
					<input type="radio" name="sung" value="1">여자 <input
					type="radio" name="sung" value="2" checked>선택안함</td>
			</tr>
			<tr>
				<td>생년월일</td>
